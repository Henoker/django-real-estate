...
class Property(TimeStampedUUIDModel):
    ...
    street_adderess = models.CharField(verbose_name=_("Street Address"), 
    max_length= 150, default="KGB Avenue")
    ...
    advert_type = models.CharField(verbose_name=_("Advert Type"), max_length=50, choices=AdvertType.
    choices, default=AdvertType.FOR_SALE)
    ...
    def save(self, *args , **kwargs):
        ...
        self.ref_code = "".join(random.choices(string.ascii_uppercase + string.
        digits, k=10))
...
#
# WAREHOUSE = "", _("") Create your models here.
